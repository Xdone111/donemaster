package com.zss.library.taglayout;
...
public class TagLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        int lineSpacing = a.getDimensionPixelSize(R.styleable.TagLayout_lineSpacing, DEFAULT_LINE_SPACING);
        int tagSpacing = a.getDimensionPixelSize(R.styleable.TagLayout_tagSpacing, DEFAULT_TAG_SPACING);
        int columnSize = a.getInteger(R.styleable.TagLayout_columnSize, DEFAULT_FIXED_COLUMN_SIZE);
