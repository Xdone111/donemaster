...
public class CommonTextWidget extends CommonWidget {
	...
	public void setLeftTextSize(int size){
		common_tv_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, size);
	}
	...
	public void setRightTextSize(int size){
		common_tv_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, size);
	}
	...
	public void setSummaryTextSize(int size){
		common_tv_summary.setTextSize(TypedValue.COMPLEX_UNIT_SP, size);
	}
