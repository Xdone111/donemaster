...
public class CommonWhiteDialog extends Dialog {
	...
	public CommonWhiteDialog(Context context) {
		...
		setContentView(R.layout.common_white_dialog);
		setCanceledOnTouchOutside(true);
		initView();
	}

	public CommonWhiteDialog(Context context, CharSequence title, CharSequence content) {
		this(context);
		common_tv_title.setText(title);
		common_tv_context.setText(content);
	}

	public CommonWhiteDialog(Context context, int title, int content) {
	...
	public void setOnClickCancelListener(View.OnClickListener onCancelListener) {
		...
		if(common_btn_confirm.getVisibility() == View.VISIBLE){
			common_btn_cancel.setBackgroundResource(R.drawable.whitedialog_bottom_left_selector);
			common_btn_confirm.setBackgroundResource(R.drawable.whitedialog_bottom_right_selector);
		}else{
			common_btn_cancel.setBackgroundResource(R.drawable.whitedialog_bottom_selector);
		}
	...
	public void setOnClickConfirmListener(View.OnClickListener onConfirmListener) {
		...
		if(common_btn_cancel.getVisibility() == View.VISIBLE){
			...
			common_btn_confirm.setBackgroundResource(R.drawable.whitedialog_bottom_selector);
		}
	...
	public void setBootomView(View v) {
		findViewById(R.id.common_ll_bottom).setVisibility(View.VISIBLE);
		setBottomBgRes(R.drawable.whitedialog_bottom_selector);
