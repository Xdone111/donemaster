...
public class AdViewPager extends RelativeLayout {
    ...
    public void setLocalResIds(List<Integer> localResIds){
        this.localResIds = localResIds;
        AdPagerAdapter adapter = new AdPagerAdapter();
        viewPager.setAdapter(adapter);
        indicator.setViewPager(viewPager);
    }
    ...
    class AdPagerAdapter extends PagerAdapter {
        @Override
        public int getCount() {
            if(urls == null && localResIds == null){
                return 0;
            }
            if (urls != null) {
                return urls.size();
            } else {
                return localResIds.size();
            }
        }
        ...
        public Object instantiateItem(ViewGroup view, int position) {
            ...
            if(urls!=null){
                ...
                image.setImageResource(localResIds.get(position));
            }
